 ...
 */
 ...
 /**
  * @file
  * Wind River CGCS Platform Link Monitor Utility
  */
 ...
 *
 * Returns : 0:single returns "single"
 *           1:vlan   returns "vlan"
 *           2:bond   returns "bond"
...
string get_iflink_interface (string & ifname )
{
    ...
    if (iflink_file_stream.is_open())
    {
        ...
        /* ERIK: Consider removing the while, this is a single line output */
            ...
            if ( line.find(str) != string::npos )
            {
                ...
                switch (ptr->type_enum)
                {
                    case single:
                    {
                        ...
                        ilog("%s is a %s network interface\n",
                    ...
                    case vlan:
                    {
                         ...
                         * parent interface, which may be a single interface
                         * or a bonded interface.
                         *
                         ****************************************************/
