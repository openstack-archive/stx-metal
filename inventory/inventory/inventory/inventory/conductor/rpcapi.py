...
class ConductorAPI(object):
    ...
    def create_ihost(self, context, values, topic=None):
    ...
    def update_ihost(self, context, ihost_obj, topic=None):
    ...
    def ibm_deprovision_by_ihost(self, context,
