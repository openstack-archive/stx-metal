...
class Connection(api.Connection):
    ...
    def _add_hosts_filters(self, query, filters):
        ...
        # if 'system_uuid' in filters:
        #     # get_system_by_uuid() to raise an exception if the system
        #     # is not found
        #     system_obj = self.get_system_by_uuid(filters['system_uuid'])
        #     query = query.filter_by(system_id=system_obj.id)
