...
def upgrade(migrate_engine):
    ...
    hosts = Table(
        ...
        Column('ihost_action', String(255)),
        ...
        Column('vsc_controllers', String(255)),
    ...
    cpus = Table(
        ...
        # Config only Column('allocated_function', String(255)),
        Column('capabilities', Text),
    ...
    ports = Table(
        ...
        # remove interface_id (on systemconfig side)
